package com.epam.example.notsolid.app;

import com.epam.example.notsolid.impl.Parallelogramm;
import com.epam.example.notsolid.impl.Rectangle;
import com.epam.example.notsolid.impl.Rhombus;
import com.epam.example.notsolid.impl.Square;

public class App {
	// the class is used instead of interface
	private static double area(Parallelogramm figure, double width, double height, double angle) {
